...
public class MyActivity extends Activity implements PropertyChangeListener {
        ...
        public void onServiceConnected(ComponentName className, IBinder service) {
            ...
            if (switchPowerService == null) {
                try {
                    ...
                    Toast.makeText(MyActivity.this, R.string.registeringDevice, Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(MyActivity.this, R.string.createDeviceFailed, Toast.LENGTH_SHORT).show();
                    return;
                }
            }
            ...
            switchPowerService.getManager().getImplementation().getPropertyChangeSupport()
                    .addPropertyChangeListener(MyActivity.this);
    ...
    protected void setLightbulb(final boolean on) {
        runOnUiThread(new Runnable() {
            public void run() {
                ImageView imageView = (ImageView) findViewById(R.id.light_image);
